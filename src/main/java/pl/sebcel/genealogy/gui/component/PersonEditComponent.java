...
public class PersonEditComponent extends AbstractEditComponent {
    ...
    private Label lSex = new Label("Płeć:");
    ...
    private Label lDeathDate = new Label("Data śmierci:");
    private Label lDeathPlace = new Label("Miejsce śmierci:");
    ...
    private Label lEducation = new Label("Wykształcenie");
    ...
    public void deleteElement(Long id) {
        int result = JOptionPane.showConfirmDialog(this, "Czy na pewno chcesz usunąć tę osobę?", "Usuwanie osoby", JOptionPane.YES_NO_OPTION);
