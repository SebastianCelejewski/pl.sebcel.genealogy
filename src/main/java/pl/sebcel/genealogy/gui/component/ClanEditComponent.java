...
public class ClanEditComponent extends AbstractEditComponent {
    ...
    public boolean saveData() {
        ...
        if (tRoot.getSelectedIndex() == 0) {
            JOptionPane.showMessageDialog(this, "Wskaż protoplastę klanu", "Błąd", JOptionPane.ERROR_MESSAGE);
            return false;
        }
    ...
    public void deleteElement(Long id) {
        int result = JOptionPane.showConfirmDialog(this, "Czy na pewno chcesz usunąć ten klan?", "Usuwanie klanu", JOptionPane.YES_NO_OPTION);
